...
- ![image-20190331234332929](assets/image-20190331234332929.png)
...
![image-20190331234233126](assets/image-20190331234233126.png)
...
![image-20190331234429222](assets/image-20190331234429222.png)
...
![image-20190331234455602](assets/image-20190331234455602.png)



### 2.继承

介绍几种常见继承方式（如需了解更多，请点击[JavaScript常见的六种继承方式](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fljianshu%2FBlog%2Fissues%2F20)）：
...
![image-20190331234538296](assets/image-20190331234538296.png)
...
![image-20190331234606391](assets/image-20190331234606391.png)
...
常见的几种跨域解决方案（具体如何实现详见[九种跨域方式实现原理（完整版）](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fljianshu%2FBlog%2Fissues%2F55)）：
...
![image-20190331234642297](assets/image-20190331234642297.png)

生命周期：localStorage 是持久化的本地存储，存储在其中的数据是永远不会过期的，使其消失的唯一办法是手动删除；而 sessionStorage 是临时性的本地存储，它是会话级别的存储，当会话结束（页面被关闭）时，存储内容也随之被释放。

![image-20190331234704295](assets/image-20190331234704295.png)

## 六、模块化

几种常见模块化规范的简介（详情请点击[前端模块化详解(完整版)](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fljianshu%2FBlog%2Fissues%2F48)）：
